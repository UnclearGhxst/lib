...
local Theme = {
    ...
    SecondaryText = Color3.fromRGB(174, 174, 180),
    MutedText = Color3.fromRGB(142, 142, 148),
...
background.BackgroundTransparency = 0.18
    ...
    backgroundGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
    ...
    waterText.Text = text
    waterText.TextColor3 = Color3.fromRGB(245, 245, 247)
...
background.BackgroundTransparency = 0.18
        ...
        notifText.Text = text
        notifText.TextColor3 = Color3.fromRGB(245, 245, 247)
...
background.BackgroundTransparency = 0.18
    ...
    xsxLogo.ImageColor3 = Color3.fromRGB(139, 92, 246)
    ...
    hashLogo.ImageColor3 = Color3.fromRGB(139, 92, 246)
    ...
    xsx.TextColor3 = Color3.fromRGB(142, 142, 148)
    xsx.TextSize = 10.000
    ...
    text.Text = "1.0.0"
    text.TextColor3 = Color3.fromRGB(142, 142, 148)
...
background.BackgroundTransparency = 0.18
    ...
    headerLabel.TextColor3 = Color3.fromRGB(245, 245, 247)
...
tabButtons.BackgroundTransparency = 0.18
    ...
    tabButtonsGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
...
container.BackgroundTransparency = 0.18
    ...
    containerGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
    ...
    function TabLibrary:NewTab(title)
        ...
        tabButton.TextColor3 = Color3.fromRGB(174, 174, 180)
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(139, 92, 246)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in pairs(tabButtons:GetChildren()) do
                if v:IsA("TextButton") then
                    TweenService:Create(v, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(174, 174, 180)}):Play()
                end
            end
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(139, 92, 246)}):Play()
        end)
...
buttonBackground.BackgroundTransparency = 0.18
            ...
            buttonGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(139, 92, 246)}):Play()
            end)
...
toggle.BackgroundTransparency = 0.18
            ...
            toggleGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(139, 92, 246)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(111, 78, 193))}
...
keybindBackground.BackgroundTransparency = 0.18
                ...
                keybindGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
...
textboxTwo.BackgroundTransparency = 0.18
                ...
                textboxTwoGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
                ...
                textBoxValues.PlaceholderColor3 = Color3.fromRGB(142, 142, 148)
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(139, 92, 246)}):Play()
                end)
...
selectorTwo.BackgroundTransparency = 0.18
            ...
            selectorText.TextColor3 = Color3.fromRGB(174, 174, 180)
            ...
            selectorTwoGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
            ...
            for i,v in next, list do
                ...
                optionButton.Text = v
                optionButton.TextColor3 = Color3.fromRGB(174, 174, 180)
                optionButton.TextSize = 14.000
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(139, 92, 246)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    for z,x in next, selectorContainer:GetChildren() do
                        if x:IsA("TextButton") then
                            TweenService:Create(x, TweenTable["selector"], {TextColor3 = Color3.fromRGB(174, 174, 180)}):Play()
                        end
                    end
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(139, 92, 246)}):Play()
            ...
            function SelectorFunctions:AddOption(new, callback_f)
                ...
                optionButton.TextColor3 = Color3.fromRGB(142, 142, 148)
                optionButton.TextSize = 14.000
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(139, 92, 246)
                    callback(selectorText.Text)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    for z,x in next, selectorContainer:GetChildren() do
                        if x:IsA("TextButton") then
                            TweenService:Create(x, TweenTable["selector"], {TextColor3 = Color3.fromRGB(142, 142, 148)}):Play()
                        end
                    end
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(139, 92, 246)}):Play()
                    selectorText.Text = optionButton.Text
...
sliderBackground.BackgroundTransparency = 0.18
            ...
            sliderBackgroundGradient.Color = ColorSequence.new(Color3.fromRGB(255, 255, 255))
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(139, 92, 246)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(124, 92, 224))}
            ...
            sliderValue.TextColor3 = Color3.fromRGB(142, 142, 148)
