...
local Theme = {
    ...
    SurfaceStrong = Color3.fromRGB(20, 20, 24),
...
local function ApplyGlass(instance, radius, transparency)
    ...
    if instance:IsA("Frame") or instance:IsA("TextButton") or instance:IsA("ScrollingFrame") then
        ...
        instance.BackgroundTransparency = transparency or 0.18
...
background.BackgroundTransparency = 0.18
    ...
    tabButtonsEdge.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
...
tabButtons.BackgroundTransparency = 0.18
    ...
    containerEdge.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
...
buttonBackground.BackgroundTransparency = 0.18
            ...
            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = Color3.fromRGB(255, 255, 255)}):Play()
            end)
...
buttonBackground.BackgroundTransparency = 0.18
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleEdge.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
