...
local Theme = {
    ...
    SurfaceStrong = Color3.fromRGB(8, 8, 11),
    Text = Theme.Text,
...
local function ApplyGlass(instance, radius, transparency)
    if not instance then return end
    if instance:IsA("Frame") or instance:IsA("TextButton") or instance:IsA("ScrollingFrame") then
        instance.BackgroundColor3 = Theme.Surface
        instance.BackgroundTransparency = transparency or 0.08
...
local function ApplyText(instance, size, color)
    if not instance or not instance:IsA("TextLabel") and not instance:IsA("TextButton") then return end
    instance.Font = Enum.Font.BuilderSans
    instance.TextSize = size or 14
...
local Theme = {
    ...
    SecondaryText = Color3.fromRGB(178, 178, 185),
    MutedText = Color3.fromRGB(120, 120, 128),
...
local function XSXCorner(instance, radius)
    local corner = instance:FindFirstChildOfClass("UICorner")
    if not corner then
        corner = Instance.new("UICorner")
        corner.Parent = instance
...
local function XSXStroke(instance, transparency)
    local stroke = instance:FindFirstChildOfClass("UIStroke")
    if not stroke then
        stroke = Instance.new("UIStroke")
        stroke.Parent = instance
...
local function XSXSurface(instance, color, transparency, radius)
    if instance:IsA("GuiObject") then
        instance.BackgroundColor3 = color or Theme.Surface
        instance.BackgroundTransparency = transparency or 0
        XSXCorner(instance, radius or Theme.Corner)
        XSXStroke(instance, 0.48)
    end
end

local function XSXText(instance, size, color)
...
background.BackgroundTransparency = 0.18
    ...
    backgroundGradient.Color = ColorSequence.new(Theme.Text)
    ...
    waterText.Size = UDim2.new(0, NewSize.X + 16, 0, 24)

    waterPadding.Name = "notifPadding"
    waterPadding.Parent = waterText
    waterPadding.PaddingBottom = UDim.new(0, 10)
    waterPadding.PaddingLeft = UDim.new(0, 10)
    waterPadding.PaddingRight = UDim.new(0, 10)
    waterPadding.PaddingTop = UDim.new(0, 10)
    ...
    coroutine.wrap(function()
        ...
        TweenService:Create(edge, TweenTable["wm"], {Size = UDim2.new(0, NewSize.X + 20, 0, 26)}):Play()
        TweenService:Create(background, TweenTable["wm"], {BackgroundTransparency = 0}):Play()
        TweenService:Create(background, TweenTable["wm"], {Size = UDim2.new(0, NewSize.X + 16, 0, 24)}):Play()
        wait(.2)
        TweenService:Create(bar, TweenTable["wm"], {Size = UDim2.new(0, NewSize.X + 16, 0, 1)}):Play()
        wait(.1)
...
background.BackgroundTransparency = 0.18
        ...
        function NewWatermarkFunctions:Text(new)
            ...
            waterText.Size = UDim2.new(0, NewSize.X + 16, 0, 24)
            coroutine.wrap(function()
                TweenService:Create(edge, TweenTable["wm_2"], {Size = UDim2.new(0, NewSize.X + 20, 0, 26)}):Play()
                TweenService:Create(background, TweenTable["wm_2"], {Size = UDim2.new(0, NewSize.X + 16, 0, 24)}):Play()
                TweenService:Create(bar, TweenTable["wm_2"], {Size = UDim2.new(0, NewSize.X + 16, 0, 1)}):Play()
                TweenService:Create(waterText, TweenTable["wm_2"], {Size = UDim2.new(0, NewSize.X + 16, 0, 1)}):Play()
            end)()
...
background.BackgroundTransparency = 0.18
        ...
        notifText.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
        ...
        coroutine.wrap(function()
            ...
            TweenService:Create(background, TweenTable["notification_load"], {Size = UDim2.new(0, NewSize.X + 16, 0, 24)}):Play()
            TweenService:Create(notifText, TweenTable["notification_load"], {Size = UDim2.new(0, NewSize.X + 16, 0, 24)}):Play()
            wait()
            TweenService:Create(bar, TweenTable["notification_wait"], {Size = UDim2.new(0, NewSize.X + 16, 0, 1)}):Play()
            repeat wait() until bar.Size == UDim2.new(0, NewSize.X + 16, 0, 1)
            IsRunning = false
...
background.BackgroundTransparency = 0.18
    ...
    xsxLogo.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
    ...
    hashLogo.ImageColor3 = Theme.Accent
    hashLogo.ImageTransparency = 1
    
    xsx.Name = "xsx"
    xsx.Parent = background
    xsx.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
    xsx.BackgroundTransparency = 1.000
    xsx.Size = UDim2.new(0, 80, 0, 21)
    xsx.Font = Enum.Font.BuilderSans
    xsx.Text = "UI Library: xsx"
    xsx.TextColor3 = Theme.MutedText
    xsx.TextSize = 10.000
...
background.BackgroundTransparency = 0.18
    ...
    headerLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
    ...
    tabButtonsEdge.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
tabButtonsEdge.BackgroundTransparency = 0.18
    ...
    tabButtons.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
tabButtons.BackgroundTransparency = 0.18
    tabButtons.ClipsDescendants = true
    tabButtons.Position = UDim2.new(0.5, 0, 0.5, 0)
    tabButtons.Size = UDim2.new(0, 150, 0, 358)

    tabButtonCorner_2.CornerRadius = UDim.new(0, 12)
    tabButtonCorner_2.Name = "tabButtonCorner"
    tabButtonCorner_2.Parent = tabButtons

    tabButtonsGradient.Color = ColorSequence.new(Theme.Text)
    ...
    containerEdge.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
containerEdge.BackgroundTransparency = 0.18
...
container.BackgroundTransparency = 0.18
    ...
    containerGradient.Color = ColorSequence.new(Theme.Text)
    ...
    function TabLibrary:NewTab(title)
        ...
        tabButton.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
        ...
        page.Active = true
        page.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in pairs(tabButtons:GetChildren()) do
                if v:IsA("TextButton") then
                    TweenService:Create(v, TweenTable["tab_text_colour"], {TextColor3 = Theme.SecondaryText}):Play()
                end
            end
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Theme.Accent}):Play()
        end)
        ...
        function Components:NewLabel(text, alignment)
            ...
            labelPadding.PaddingBottom = UDim.new(0, 10)
        ...
        function Components:NewButton(text, callback)
            ...
            buttonFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
...
button.BackgroundTransparency = 0.18
            ...
            buttonBackground.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
buttonBackground.BackgroundTransparency = 0.18
            buttonBackground.Position = UDim2.new(0.5, 0, 0.5, 0)
            buttonBackground.Size = UDim2.new(0, 394, 0, 22)

            buttonGradient.Color = ColorSequence.new(Theme.Text)
            buttonGradient.Rotation = 90
            buttonGradient.Name = "buttonGradient"
            buttonGradient.Parent = buttonBackground

            buttonBackCorner.CornerRadius = UDim.new(0, 12)
            ...
            buttonLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            buttonLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
            buttonLabel.TextSize = 14.000
            buttonLabel.RichText = true

            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = Color3.fromRGB(10, 10, 12)}):Play()
            end)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Theme.Accent}):Play()
            end)
            button.MouseButton1Up:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(225, 225, 230)}):Play()
            end)
...
buttonBackground.BackgroundTransparency = 0.18
        ...
        function Components:NewSection(text)
            ...
            sectionFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            sectionLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            sectionLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
            ...
            rightBar.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleButton.Font = Enum.Font.BuilderSans
            toggleButton.Text = ""
            toggleButton.TextColor3 = Color3.fromRGB(225, 225, 230)
            ...
            toggleEdge.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
toggleEdge.BackgroundTransparency = 0.18
            toggleEdge.Size = UDim2.new(0, 18, 0, 18)

            toggleEdgeCorner.CornerRadius = UDim.new(0, 12)
...
toggle.BackgroundTransparency = 0.18
            ...
            toggleGradient.Color = ColorSequence.new(Theme.Text)
            ...
            toggleDesign.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            toggleDesign.BackgroundTransparency = 1.000
            toggleDesign.Position = UDim2.new(0.5, 0, 0.5, 0)

            toggleDesignCorner.CornerRadius = UDim.new(0, 12)
            toggleDesignCorner.Name = "toggleDesignCorner"
            toggleDesignCorner.Parent = toggleDesign

            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Theme.Accent), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(111, 78, 193))}
            ...
            toggleLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            toggleLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
            ...
            toggleLabelPadding.PaddingLeft = UDim.new(0, 10)
            ...
            ExtrasLayout.Padding = UDim.new(0, 12)
            ...
            toggleButton.MouseLeave:Connect(function()
                TweenService:Create(toggleLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(225, 225, 230)}):Play()
            end)
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybind.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
keybind.BackgroundTransparency = 0.18
                keybind.Position = UDim2.new(0.780303001, 0, 0, 0)
                keybind.Size = UDim2.new(0, 87, 0, 22)
                keybind.AutoButtonColor = false
                keybind.Font = Enum.Font.BuilderSans
                keybind.Text = ""
                ...
                keybindBackground.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
keybindBackground.BackgroundTransparency = 0.18
                keybindBackground.Position = UDim2.new(0.5, 0, 0.5, 0)
                keybindBackground.Size = UDim2.new(0, 85, 0, 20)
    
                keybindGradient.Color = ColorSequence.new(Theme.Text)
                keybindGradient.Rotation = 90
                keybindGradient.Name = "keybindGradient"
                keybindGradient.Parent = keybindBackground
    
                keybindBackCorner.CornerRadius = UDim.new(0, 12)
                ...
                keybindButtonLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
                ...
                keybindButtonLabel.Font = Enum.Font.BuilderSans
                keybindButtonLabel.Text = ". . ."
                keybindButtonLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
        ...
        function Components:NewKeybind(text, default, callback)
            ...
            keybindFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            keybindButton.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            keybindButton.BackgroundTransparency = 1.000
            keybindButton.Size = UDim2.new(0, 396, 0, 24)
            keybindButton.AutoButtonColor = false
            keybindButton.Font = Enum.Font.BuilderSans
            keybindButton.Text = ""
            ...
            keybindLayout.Padding = UDim.new(0, 10)

            keybindLabel.Name = "keybindLabel"
            keybindLabel.Parent = keybindButton
            keybindLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            keybindLabel.BackgroundTransparency = 1.000
            keybindLabel.Size = UDim2.new(0, 396, 0, 24)
            keybindLabel.Font = Enum.Font.BuilderSans
            keybindLabel.Text = text
            keybindLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
            ...
            keybindFolderLayout.Padding = UDim.new(0, 10)
...
keybindBackground.BackgroundTransparency = 0.18
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textboxFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
                ...
                textboxFolderLayout.Padding = UDim.new(0, 10)
...
textbox.BackgroundTransparency = 0.18
                ...
                textboxTwo.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
textboxTwo.BackgroundTransparency = 0.18
                ...
                textBoxValues.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
                ...
                textBoxValues.Font = Enum.Font.BuilderSans
                textBoxValues.PlaceholderColor3 = Theme.MutedText
                textBoxValues.PlaceholderText = place
                textBoxValues.Text = ""
                textBoxValues.TextColor3 = Color3.fromRGB(225, 225, 230)
                ...
                textBoxValuesPadding.PaddingBottom = UDim.new(0, 10)
                textBoxValuesPadding.PaddingLeft = UDim.new(0, 10)
                textBoxValuesPadding.PaddingRight = UDim.new(0, 10)
                textBoxValuesPadding.PaddingTop = UDim.new(0, 10)
                ...
                textboxLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
                textboxLabel.BackgroundTransparency = 1.000
                textboxLabel.Size = UDim2.new(0, 396, 0, 24)
                textboxLabel.Font = Enum.Font.BuilderSans
                textboxLabel.Text = text
                textboxLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
                ...
                textboxFrame.MouseLeave:Connect(function()
                    TweenService:Create(textboxLabel, TweenTable["TextBox"], {TextColor3 = Color3.fromRGB(225, 225, 230)}):Play()
                end)

                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Theme.Accent}):Play()
                end)

                textBoxValues.FocusLost:Connect(function()
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(10, 10, 12)}):Play()
                end)
...
textboxTwo.BackgroundTransparency = 0.18
                ...
                textBoxValuesPadding.Name = "textBoxValuesPadding"
                textBoxValuesPadding.Parent = textBoxValues
                textBoxValuesPadding.PaddingBottom = UDim.new(0, 12)
                textBoxValuesPadding.PaddingLeft = UDim.new(0, 12)
                textBoxValuesPadding.PaddingRight = UDim.new(0, 12)
                textBoxValuesPadding.PaddingTop = UDim.new(0, 12)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            selectorFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            selectorLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            selectorLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
            ...
            selectorLabelPadding.PaddingBottom = UDim.new(0, 10)
            selectorLabelPadding.PaddingLeft = UDim.new(0, 12)
            selectorLabelPadding.PaddingRight = UDim.new(0, 10)
            selectorLabelPadding.PaddingTop = UDim.new(0, 10)
            ...
            selector.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
selector.BackgroundTransparency = 0.18
            ...
            selector.Font = Enum.Font.BuilderSans
            selector.Text = ""
            ...
            selectorTwo.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
selectorTwo.BackgroundTransparency = 0.18
            ...
            selectorText.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            selectorText.BackgroundTransparency = 1.000
            selectorText.Size = UDim2.new(0, 394, 0, 20)
            selectorText.Font = Enum.Font.BuilderSans
            selectorText.LineHeight = 1.150
            selectorText.TextColor3 = Theme.SecondaryText
            ...
            selectorContainer.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            for i,v in next, list do
                ...
                optionButton.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    for z,x in next, selectorContainer:GetChildren() do
                        if x:IsA("TextButton") then
                            TweenService:Create(x, TweenTable["selector"], {TextColor3 = Theme.SecondaryText}):Play()
                        end
                    end
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Theme.Accent}):Play()
            ...
            function SelectorFunctions:AddOption(new, callback_f)
                ...
                optionButton.TextColor3 = Theme.MutedText
                optionButton.TextSize = 14.000
                if optionButton.Text == default then
                    optionButton.TextColor3 = Theme.Accent
                    callback(selectorText.Text)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    for z,x in next, selectorContainer:GetChildren() do
                        if x:IsA("TextButton") then
                            TweenService:Create(x, TweenTable["selector"], {TextColor3 = Theme.MutedText}):Play()
                        end
                    end
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Theme.Accent}):Play()
                    selectorText.Text = optionButton.Text
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            sliderButton.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
sliderButton.BackgroundTransparency = 0.18
            sliderButton.Position = UDim2.new(0.348484844, 0, 0.600000024, 0)
            sliderButton.Size = UDim2.new(0, 396, 0, 16)
            sliderButton.AutoButtonColor = false
            sliderButton.Font = Enum.Font.BuilderSans
            sliderButton.Text = ""
            ...
            sliderBackground.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
sliderBackground.BackgroundTransparency = 0.18
            ...
            sliderButtonCorner_2.CornerRadius = UDim.new(0, 12)
            sliderButtonCorner_2.Name = "sliderButtonCorner"
            sliderButtonCorner_2.Parent = sliderBackground

            sliderBackgroundGradient.Color = ColorSequence.new(Theme.Text)
            ...
            sliderIndicator.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Theme.Accent), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(124, 92, 224))}
            ...
            sliderIndicatorCorner.CornerRadius = UDim.new(0, 12)
            ...
            sliderBackgroundPadding.PaddingBottom = UDim.new(0, 12)
            sliderBackgroundPadding.PaddingLeft = UDim.new(0, 1)
            sliderBackgroundPadding.PaddingRight = UDim.new(0, 1)
            sliderBackgroundPadding.PaddingTop = UDim.new(0, 12)
            ...
            sliderLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            sliderLabel.BackgroundTransparency = 1.000
            sliderLabel.Size = UDim2.new(0, 396, 0, 24)
            sliderLabel.Font = Enum.Font.BuilderSans
            sliderLabel.Text = text
            sliderLabel.TextColor3 = Color3.fromRGB(225, 225, 230)
            ...
            sliderValue.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
            sliderValue.BackgroundTransparency = 1.000
            sliderValue.Position = UDim2.new(0.577319562, 0, 0, 0)
            sliderValue.Size = UDim2.new(0, 169, 0, 15)
            sliderValue.Font = Enum.Font.BuilderSans
            sliderValue.Text = values.default
            sliderValue.TextColor3 = Theme.MutedText
...
--// XSX Apple Glass v2 final polish pass
task.defer(function()
    local root = CoreGui:FindFirstChild("XSX") or CoreGui:FindFirstChild("xsx")
    if not root then return end

    for _, object in ipairs(root:GetDescendants()) do
        if object:IsA("Frame") or object:IsA("ScrollingFrame") then
            if object.BackgroundTransparency < 1 then
                if object.AbsoluteSize.X > 260 and object.AbsoluteSize.Y > 100 then
                    XSXSurface(object, Theme.Surface, 0.06, Theme.Corner)
                else
                    XSXSurface(object, Theme.Surface2, 0.02, Theme.SmallCorner)
                end
            end
        elseif object:IsA("TextButton") then
            XSXText(object, object.TextSize, Theme.Text)
            XSXCorner(object, Theme.SmallCorner)
            XSXStroke(object, 0.55)

            local normal = object.BackgroundColor3
            ...
            object.MouseLeave:Connect(function()
                pcall(function()
                    TweenService:Create(object, TweenInfo.new(0.20, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = normal
                    }):Play()
                end)
            end)
        elseif object:IsA("TextLabel") then
            XSXText(object, object.TextSize, object.TextColor3)
        elseif object:IsA("TextBox") then
            XSXText(object, object.TextSize, Theme.Text)
            XSXCorner(object, Theme.SmallCorner)
            XSXStroke(object, 0.5)
        end
    end
end)